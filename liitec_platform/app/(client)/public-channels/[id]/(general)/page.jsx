...
} from "@/config/PublicDevicesConfig";
  ...
  return (
    <>
      ...
      <GenericTable
        ...
        columns={PublicDeviceTableColumns}
        renderCell={PublicDeviceTableRenderCell}
        idField={"deviceId"}
        statusOptions={PublicDeviceTableStatusOptions}
        initialColumns={PublicDeviceTableInitialColumns}
